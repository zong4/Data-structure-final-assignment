...
int main()
{
    ...
    //2.1.2��ѯָ��ͼ�
    col.Authorsearch("rt");//������������
    col.Idsearch(4).ShowData();//���������������ΪIDΨһ������ֻ�����һ����
    col.Timesearch(Time(2020, 1, 7), Time(2020, 1, 8));//�����ղ�ʱ������
    //2.1.3��������ʾ����ͼ��
    col.Savesort();//�����ղ�ʱ������
    //2.1.4���۸��С��ʾ���
    col.Pricesort();
    ...
    shop.show();
    //2.2.2��ѯָ��ͼ��
    shop.Authorsearch("fsf");//������������
    shop.Idsearch(1).ShowData();//���������������ΪIDΨһ������ֻ�����һ����
    shop.Timesearch(Time(2020, 1, 7), Time(2020, 1, 8));//�����ղ�ʱ������
    //2.2.3�޸Ĺ�������
