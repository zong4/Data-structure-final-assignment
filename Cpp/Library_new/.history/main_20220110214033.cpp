...
int main()
{
    Book b1(1,"22", "33", "44", 2020, 3, 0, 35, 1);
    Book b2(2,"55", "e", "e", 2014, 7, 0, 39.3, 1);
    Book b3(3,"d", "g", "f", 2018, 8, 0, 36.8, 1);
    Book b4(4,"g", "g", "c", 2014, 7, 0, 47.6, 1);
    Shop shop(1000);
    Set set(1000);
    Collect col(1000);
    //�ղؼ���ϵͳ���ܲ���
    ...
    col.show();
    //2.1.2��ѯָ��ͼ��
    col.Authorsearch("f").show();//������������
    col.Idsearch(1).ShowData();//���������������ΪIDΨһ������ֻ�����һ����
    col.Timesearch(Time(2014, 6, 0), Time(2018, 0, 0)).show();//�����ղ�ʱ������
    //2.1.3��������ʾ����ͼ��
    ...
    shop.show();
    //2.2.2��ѯָ��ͼ��
    shop.Authorsearch("fff").show();//������������
    shop.Idsearch(1).ShowData();//���������������ΪIDΨһ������ֻ�����һ����
    shop.Timesearch(Time(2014, 6, 0), Time(2018, 0, 0)).show();//�����ղ�ʱ������
    //2.2.3�޸Ĺ�������
    ...
    shop.Idsort();
    shop.show();
    cout << "vv" << shop.Countnum() << "vv" << "  " << "hh:" << shop.Countprice() << endl;
    //�����ϵͳ
    //2.3.1����ָ��ͼ��
    set.insert(b1);
    b1.setSaveTime(2020, 1, 7);
